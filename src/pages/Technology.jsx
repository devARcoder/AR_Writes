...
const Technology = () => {
    // const filterCataData = blogData.filter((catagory) => catagory.category === "Technology")
  return (
    <>
      <div className="text-white bg-[#222] px-6 py-4 md:px-9 lg:px-16 lg:space-x-8">
        <Breadcrumbs cataName="Technology"/>

        <CataHeading heading="Technology" paragraph="Stay ahead of the curve with the newest developments in technology, from cutting-edge gadgets to breakthroughs in AI, cybersecurity, and beyond."/>
